        ...
        return new Dictionary<CharacterState, SpriteAnimationClipDefinition>{
            {
                ...
                CreateSpriteAnimationClipDefinition (true, string.Format("{0}/Default.anim", outputDirectoryName), sprites[1][0], sprites[1][1], sprites[1][2], sprites[1][1])
            },
            {
                CharacterState.Dead,
                CreateSpriteAnimationClipDefinition (false, string.Format("{0}/Dead.anim", outputDirectoryName), sprites[2][9], sprites[2][10],sprites[2][11])
            },
            {
                CharacterState.Pinch,
                CreateSpriteAnimationClipDefinition (true, string.Format("{0}/Pinch.anim", outputDirectoryName), sprites[1][6], sprites[1][7], sprites[1][8], sprites[1][7])
            },
            {
                CharacterState.Hit,
                CreateSpriteAnimationClipDefinition (false, string.Format("{0}/Hit.anim", outputDirectoryName), sprites[1][3], sprites[1][4], sprites[1][5])
            },
            {
                CharacterState.Attack,
                CreateSpriteAnimationClipDefinition (false, string.Format("{0}/Attack.anim", outputDirectoryName), sprites[3][0], sprites[3][1], sprites[3][2])
            },
            {
                CharacterState.Down,
                CreateSpriteAnimationClipDefinition (true, string.Format("{0}/Down.anim", outputDirectoryName), sprites[0][0], sprites[0][1], sprites[0][2], sprites[0][1])
            },
            {
                CharacterState.Left,
                CreateSpriteAnimationClipDefinition (true, string.Format("{0}/Left.anim", outputDirectoryName), sprites[0][3], sprites[0][4], sprites[0][5], sprites[0][3])
            },
            {
                CharacterState.Right,
                CreateSpriteAnimationClipDefinition (true, string.Format("{0}/Right.anim", outputDirectoryName), sprites[0][6], sprites[0][7], sprites[0][8], sprites[0][7])
            },
            {
                CharacterState.Up,
                CreateSpriteAnimationClipDefinition (true, string.Format("{0}/Up.anim", outputDirectoryName), sprites[0][9], sprites[0][10], sprites[0][11], sprites[0][10])
            },
        };
    }

    static SpriteAnimationClipDefinition CreateSpriteAnimationClipDefinition(bool isLoop, string resultPath, params Sprite[] sprites)
    {
